#ifndef GRA25SPROJECT_T033_1_SECUREMEMORYUNIT_DEBUG_HPP
#define GRA25SPROJECT_T033_1_SECUREMEMORYUNIT_DEBUG_HPP
                ...
                if(r.read()) {
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        ...
                        if (parity_memory.find(addresses[i]) != parity_memory.end()) {
                            ...
                            // printf("address %d: %02X, Parity: %d\n", byteIndex, addresses[byteIndex], parity_memory[addresses[byteIndex]]);
                    ...
                    printf("Read data: 0x%08X from logical address: 0x%08X\n", data_r, addr.read());
                    fflush(stdout);
...
#endif //GRA25SPROJECT_T033_1_SECUREMEMORYUNIT_DEBUG_HPP
